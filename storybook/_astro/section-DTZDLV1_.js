import{u as i,k as e,d}from"./blocks-p3lTjQnC.js";import{S as a}from"./section.stories-f6MY5qmb.js";import"./preload-helper-C91jIAhM.js";function t(r){const n={code:"code",em:"em",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...i(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(d,{of:a}),`
...
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsx("a",{href:"https://cyndamedialab.github.io/vibranthealth-brand-styleguide/web/components/",target:"_blank",rel:"noopener noreferrer",children:"Web → Components"}),`
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsx("a",{href:"https://cyndamedialab.github.io/vibranthealth-brand-styleguide/web/iconography/",target:"_blank",rel:"noopener noreferrer",children:"Web → Iconography"}),`
`]}),`
`,e.jsxs(n.li,{children:[`
...
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsx("a",{href:"https://cyndamedialab.github.io/vibranthealth-brand-styleguide/web/navigation/",target:"_blank",rel:"noopener noreferrer",children:"Web → Navigation"}),`
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsx("a",{href:"https://cyndamedialab.github.io/vibranthealth-brand-styleguide/web/spacing-radius/",target:"_blank",rel:"noopener noreferrer",children:"Web → Spacing & Radius"}),`
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsx("a",{href:"https://cyndamedialab.github.io/vibranthealth-brand-styleguide/web/typography/",target:"_blank",rel:"noopener noreferrer",children:"Web → Typography"}),`
`]}),`
`]}),`
...
import Section from "../components/section/section.astro";\r
---\r
\r
<Section\r
  id="colors"\r
  title="Colors"\r
  description="Our core palette and how to apply it."\r
>\r
  {/* swatches, cards, etc. */}\r
</Section>
`})})]})}function o(r={}){const{wrapper:n}={...i(),...r.components};return n?e.jsx(n,{...r,children:e.jsx(t,{...r})}):t(r)}export{o as default};

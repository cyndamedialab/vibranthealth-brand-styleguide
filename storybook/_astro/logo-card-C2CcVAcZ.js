import{u as s,k as e,d as t}from"./blocks-Bth8_9u1.js";import{L as o}from"./logo-card.stories-BTS3IWA1.js";import"./preload-helper-D1UD9lgW.js";function r(n){const d={code:"code",em:"em",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...s(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(t,{of:o}),`
...
import LogoCard from "../components/logo-card/logo-card.astro";
---

{/* Logo with a clickable download footer */}
<LogoCard
  ...
  logoWidth={200}
  showDownload
  downloadHref="/logos/primary.svg.tar.gz"
/>

{/* Logo with a heading region listing trademarks */}
<LogoCard
  heading="Product Names"
  headingItems={["Green Vibrance®", "Trilogy®"]}
  title="Primary Logo • One Line • Registered"
  logoImageSrc="/logos/secondary-r.svg"
  showDownload
  downloadHref="/logos/secondary-r.svg.tar.gz"
/>

{/* Compact label, no download */}
<LogoCard
  title="The Atom"
  description="Regular & Extended"
  titleSize="small"
  logoImageSrc="/marks/atom.svg"
/>

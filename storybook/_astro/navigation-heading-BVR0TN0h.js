import{u as r,k as e,d}from"./blocks-Bth8_9u1.js";import{N as s}from"./navigation-heading.stories-j1ntSChA.js";import"./preload-helper-D1UD9lgW.js";function i(t){const n={code:"code",h1:"h1",h2:"h2",li:"li",p:"p",pre:"pre",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...r(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(d,{of:s}),`
...
`})}),`
`,e.jsx(n.p,{children:"Renders the Vibrant Health logo and the “Brand Style Guidelines” tag; the content is built in, so no slot or label is required."})]})}function c(t={}){const{wrapper:n}={...r(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(i,{...t})}):i(t)}export{c as default};

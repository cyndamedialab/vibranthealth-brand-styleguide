...
import NavigationHeading from "../components/navigation-heading/navigation-heading.astro";\r
---\r
\r
<NavigationHeading href="/" />
`})}),`
`,e.jsx(n.p,{children:"Renders the Vibrant Health logo and the “Brand Style Guidelines” tag; the content is built in, so no slot or label is required."})]})}function l(i={}){const{wrapper:n}={...r(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(t,{...i})}):t(i)}export{l as default};

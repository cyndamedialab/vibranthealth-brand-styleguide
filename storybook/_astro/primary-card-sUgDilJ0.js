...
---\r
\r
{/* Navy header with description prop */}\r
<PrimaryCard\r
  title="Logo Library"\r
  tagline="Download"\r
  description="All approved logo files in one place."\r
/>\r
\r
{/* Green header with multiple paragraphs */}\r
<PrimaryCard\r
  headerColor="green"\r
  title="WHAT"\r
  tagline="Product/Result"\r
  description={["Founded in 1992.", "Rigorously tested nutritional supplements."]}\r
/>\r
\r
{/* Linked card */}\r
<PrimaryCard\r
  title="Photography"\r
  href="/brand-identity/photography/"\r
  description="Our visual style and guidelines."\r
/>

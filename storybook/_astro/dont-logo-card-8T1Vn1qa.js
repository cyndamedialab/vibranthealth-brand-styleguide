import{u as d,k as e,d as o}from"./blocks-p3lTjQnC.js";import{D as s}from"./dont-logo-card.stories-71Ar_Qwo.js";import"./preload-helper-C91jIAhM.js";function r(t){const n={code:"code",em:"em",h1:"h1",h2:"h2",li:"li",p:"p",pre:"pre",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...d(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(o,{of:s}),`
...
import DontLogoCard from "../components/dont-logo-card/dont-logo-card.astro";\r
---\r
\r
<DontLogoCard case={1} caption="Don't change the logo color." />\r
<DontLogoCard case={4} caption="Don't stretch or distort the logo." />
`})}),`
`,e.jsxs(n.p,{children:["The illustration art is built in and chosen via ",e.jsx(n.code,{children:"case"}),"; the component renders the red “Don't” header automatically."]})]})}function h(t={}){const{wrapper:n}={...d(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(r,{...t})}):r(t)}export{h as default};

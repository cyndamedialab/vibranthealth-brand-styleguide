import{u as i,k as e,d as a}from"./blocks-p3lTjQnC.js";import{H as d}from"./hero.stories-VR0NJemJ.js";import"./preload-helper-C91jIAhM.js";function t(r){const n={code:"code",em:"em",h1:"h1",h2:"h2",li:"li",p:"p",pre:"pre",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...i(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(a,{of:d}),`
`,e.jsx(n.h1,{id:"hero",children:"Hero"}),`
`,e.jsx(n.p,{children:"The page header used at the top of every styleguide page."}),`
...
`,e.jsxs(n.table,{children:[e.jsx(n.thead,{children:e.jsxs(n.tr,{children:[e.jsx(n.th,{children:"Prop"}),e.jsx(n.th,{children:"Type"}),e.jsx(n.th,{children:"Default"}),e.jsx(n.th,{children:"Description"})]})}),e.jsxs(n.tbody,{children:[e.jsxs(n.tr,{children:[e.jsx(n.td,{children:e.jsx(n.code,{children:"title"})}),e.jsx(n.td,{children:e.jsx(n.code,{children:"string"})}),e.jsxs(n.td,{children:["— ",e.jsx(n.em,{children:"(required)"})]}),e.jsxs(n.td,{children:["Page title rendered as the ",e.jsx(n.code,{children:"<h1>"}),"."]})]}),e.jsxs(n.tr,{children:[e.jsx(n.td,{children:e.jsx(n.code,{children:"description"})}),e.jsx(n.td,{children:e.jsx(n.code,{children:"string"})}),e.jsx(n.td,{children:"—"}),e.jsx(n.td,{children:"Optional intro paragraph shown below the title."})]}),e.jsxs(n.tr,{children:[e.jsx(n.td,{children:e.jsx(n.code,{children:"class"})}),e.jsx(n.td,{children:e.jsx(n.code,{children:"string"})}),e.jsx(n.td,{children:"—"}),e.jsxs(n.td,{children:["Extra class names appended to the root ",e.jsx(n.code,{children:"<header>"}),"."]})]})]})]}),`
`,e.jsx(n.h2,{id:"usage",children:"Usage"}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-tsx",children:`---\r
import Hero from "../components/hero/hero.astro";\r
---\r
\r
<Hero\r
  title="Brand Identity"\r
  description="The core elements that make Vibrant Health recognizable."\r
/>
`})}),`
`,e.jsxs(n.p,{children:["Place one ",e.jsx(n.code,{children:"Hero"})," at the top of each page."]})]})}function o(r={}){const{wrapper:n}={...i(),...r.components};return n?e.jsx(n,{...r,children:e.jsx(t,{...r})}):t(r)}export{o as default};

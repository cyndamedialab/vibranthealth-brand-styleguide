const s=()=>{throw new Error("Astro components are rendered server-side by Storybook.")};s.isAstroComponentFactory=!0;s.moduleId="C:/Users/17327/websites/vibranthealth/brand-styleguide/src/components/download-header/download-header.astro";const o={title:"Reusable/Download Header",component:s},e={args:{title:"Inter",subtitle:"Design system typeface",href:"#",download:!0}},t={args:{title:"Poppins",subtitle:"Feature display typeface",note:"OFL licensed · 18 styles",href:"#",download:!0}},r={args:{title:"IBM Plex Sans",subtitle:"Label typeface",href:"#",embedded:!0}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  args: {
    title: "Inter",

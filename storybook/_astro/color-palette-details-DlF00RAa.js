import{u as n,k as e,d as t}from"./blocks-p3lTjQnC.js";import{C as l}from"./color-palette-details.stories-B6M0bqa8.js";import"./preload-helper-C91jIAhM.js";function s(d){const r={code:"code",em:"em",h1:"h1",h2:"h2",li:"li",p:"p",pre:"pre",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...n(),...d.components};return e.jsxs(e.Fragment,{children:[e.jsx(t,{of:l}),`
...
import ColorPaletteDetails from "../components/color-palette-details/color-palette-details.astro";\r
---\r
\r
<ColorPaletteDetails\r
  role="Primary"\r
  hex="#002C4E"\r
  pantone="2965 C"\r
  textLight={true}\r
  mix={[{ label: "Base", value: "100%" }]}\r
  rgb={["0", "44", "78"]}\r
  cmyk={["100", "44", "0", "69"]}\r
  cielab={["18", "1", "-24"]}\r
  tags={["Backgrounds", "Headlines"]}\r
/>

import{u as t,k as e,d as s}from"./blocks-Bth8_9u1.js";import{D as i}from"./download-header.stories-Dt2FHYhw.js";import"./preload-helper-D1UD9lgW.js";function r(d){const n={code:"code",em:"em",h1:"h1",h2:"h2",li:"li",p:"p",pre:"pre",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...t(),...d.components};return e.jsxs(e.Fragment,{children:[e.jsx(s,{of:i}),`
...
import DownloadHeader from "../components/download-header/download-header.astro";
---

<DownloadHeader
  title="VH New Order"
  subtitle="OTF · 4 weights"
  note="For packaging use only"
  href="/fonts/vh-new-order.zip"
  download
/>
`})})]})}function c(d={}){const{wrapper:n}={...t(),...d.components};return n?e.jsx(n,{...d,children:e.jsx(r,{...d})}):r(d)}export{c as default};

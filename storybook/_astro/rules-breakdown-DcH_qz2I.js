import{u as s,k as e,d}from"./blocks-p3lTjQnC.js";import{R as l}from"./rules-breakdown.stories-CZQZzTTn.js";import"./preload-helper-C91jIAhM.js";function t(r){const n={code:"code",em:"em",h1:"h1",h2:"h2",li:"li",p:"p",pre:"pre",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...s(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(d,{of:l}),`
...
import RulesBreakdown from "../components/rules-breakdown/rules-breakdown.astro";\r
---\r
\r
<RulesBreakdown\r
  rules={[\r
    { label: "Lighting", body: "Natural, soft, and bright." },\r
    { label: "Composition", body: "Generous negative space." },\r
  ]}\r
/>

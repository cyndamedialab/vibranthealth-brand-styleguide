...
import ImageCard from "../components/image-card/image-card.astro";\r
---\r
\r
{/* Single image */}\r
<ImageCard images="/images/photo.jpg" />\r
\r
{/* Multiple images side by side */}\r
<ImageCard images={["/images/a.jpg", "/images/b.jpg"]} />\r
\r
{/* Edge-to-edge cover image */}\r
<ImageCard images="/images/hero.jpg" noPadding minHeight="320px" />
`})})]})}function c(d={}){const{wrapper:n}={...i(),...d.components};return n?e.jsx(n,{...d,children:e.jsx(r,{...d})}):r(d)}export{c as default};
